...
export function Hero() {
  ...
  return (
    <div ref={containerRef} className="relative h-[300vh]" style={{ position: 'relative' }}>
      <div className="sticky top-0 h-screen w-full overflow-hidden flex items-center justify-center bg-[#F2F0ED]">
        ...
        >
          ...
          <div 
            ...
            style={{
              backgroundImage: `linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url(https://images.unsplash.com/photo-1530538987395-032d1800fdd4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxvbGQlMjBib29rc2hlbGYlMjB2aW50YWdlJTIwZmlsbXxlbnwxfHx8fDE3NzIyNjY2NjV8MA&ixlib=rb-4.1.0&q=80&w=1080)`,
